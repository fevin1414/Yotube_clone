...
const Feed = () => {
  ...
  return (
    <Stack sx={{ flexDirection: { sx: "column", md: "row" }, backgroundColor:"white", width: "100%" }}>
      <Box sx={{ height: { sx: "auto", md: "auto" }, borderRight: "1px solid #3d3d3d", px: { sx: 0, md: 2 } }}>
        <Sidebar selectedCategory={selectedCategory} setSelectedCategory={setSelectedCategory} />

        <Typography className="copyright" variant="body2" sx={{ mt: 1.5, color: "black",background:"white" }}>
